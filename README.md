...
* Not the upstream architecture. This is the externalized math kernel plus its audit infrastructure. The upstream substrate (private measurement, evaluation, and signal-processing components; Hill ξ and Fisher-Rao among the public methods it draws on) is intact upstream and not in this repo.
