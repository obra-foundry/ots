...
class CumulantFinding:
    ...
    provenance_chain_id: str = "IC-v1.0::marginal-cumulant-divergence"
...
class SheafFinding:
    ...
    provenance_chain_id: str = "IC-v1.0::binary-gluing"
...
class AdmissionFinding:
    ...
    admit: bool
    blocking_component: Optional[str]
    provenance_chain_id: str = "IC-v1.0::per-component-AND-gate"
...
class ICRFinding:
    ...
    value_b: float
    units: str = ""
    provenance_chain_id: str = "IC-v1.0::intercept-to-compound-ratio"
